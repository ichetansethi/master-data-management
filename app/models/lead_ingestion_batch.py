...
class LeadIngestionBatch(Base):
    ...
    status: Mapped[LeadIngestionBatchStatus] = mapped_column(Enum(LeadIngestionBatchStatus, name="leadingestionbatchstatus"), nullable=False, default=LeadIngestionBatchStatus.PENDING)
